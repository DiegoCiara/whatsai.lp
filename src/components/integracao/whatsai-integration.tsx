...
function IntegrationStepCard({
  ...
  return (
    <Card
      className={`card-animate relative flex-1 min-h-[260px] max-w-xs w-full sm:max-w-sm md:max-w-xs flex flex-col mx-auto ${
    ...
    >
      ...
      <CardContent className="pl-4 pr-4 pt-6 pb-6 flex-1 flex flex-col gap-4">
        <img src={sourceHeader} alt="" className="w-16 h-16 sm:w-24 sm:h-24 object-contain mx-auto" />
